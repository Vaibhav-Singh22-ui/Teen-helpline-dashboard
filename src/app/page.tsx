...
import { 
  ...
  CheckCircle2, AlertCircle, X, ChevronLeft, ChevronRight, Plus, Send, Lock, 
...
export default function Dashboard() {
  ...
  return (
    <div className="subapp-container" style={{ gridTemplateColumns: isCollapsed ? '75px 1fr' : '260px 1fr' }}>
      
      {/* 1. LEFT SIDEBAR NAVIGATION (Desktop Only - Hidden under 900px via media queries) */}
      <aside className="subapp-sidebar" style={{ 
        padding: isCollapsed ? '2rem 0.6rem' : '2rem 1.5rem', 
        alignItems: isCollapsed ? 'center' : 'stretch',
      }}>
        <div className="subapp-sidebar-top" style={{ alignItems: isCollapsed ? 'center' : 'stretch', width: '100%' }}>
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', width: '100%' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: isCollapsed ? 'center' : 'space-between', width: '100%' }}>
              <div className="subapp-logo" style={{ display: 'flex', alignItems: 'center', gap: '0.6rem', cursor: 'pointer' }} onClick={() => { router.push('/'); }}>
                <img src="/logo_icon.png" alt="TeenHelpline Logo" style={{ height: '36px', width: '36px', objectFit: 'contain', flexShrink: 0 }} />
                {!isCollapsed && (
                  <div>
          ...
          <nav className="subapp-nav" style={{ alignItems: isCollapsed ? 'center' : 'stretch', width: '100%', marginTop: '1rem' }}>
        ...
        <div className="subapp-sidebar-bottom" style={{ alignItems: isCollapsed ? 'center' : 'stretch', width: '100%' }}>
          {profile && (
            isCollapsed ? (
              <div title={`${profile.display_name} (${profile.points} points)`} style={{ marginBottom: '0.8rem', display: 'flex', justifyContent: 'center', width: '100%' }}>
                <img 
          ...
          <button 
            ...
            style={{ 
              ...styles.exitBtn, 
              justifyContent: isCollapsed ? 'center' : 'flex-start',
              padding: isCollapsed ? '0.6rem 0' : '0.6rem 1.2rem',
              width: isCollapsed ? '44px' : '100%',
              minWidth: 0,
              height: isCollapsed ? '44px' : 'auto',
